...
* REMAKE OF RAFI GRAPHY × BRYAN GAY:V
...
const { help } = require('./RAFI/help')
const { rules } = require('./RAFI/rules')
const { bahasa } = require('./RAFI/bahasa')
const { donasi } = require('./RAFI/donasi')
const { limits } = require('./RAFI/limit')
const { bokep } = require('./RAFI/bokep.js')
const { ownermenu } = require('./RAFI/ownermenu.js')
const { groupmenu } = require('./RAFI/groupmenu.js')
const { mediamenu } = require('./RAFI/mediamenu.js')
const { nsfwmenu } = require('./RAFI/nsfwmenu.js')
const { listmenu } = require('./RAFI/listmenu.js')
const { funmenu } = require('./RAFI/funmenu.js')
const { makermenu } = require('./RAFI/makermenu.js')
//jangan hiraukan ini!!,,,ini uji coba yang gagal:) kontol//
//const { gabutmenu } = require('./RAFI/gabutmenu')
//const { ownermenu } = require('./RAFI/ownermenu')
//const { groupmenu } = require('./RAFI/groupmenu')
//const { vipmenu } = require('./RAFI/vipmenu')
//const { nsfwmenu } = require('./RAFI/nsfwmenu')
//const { creatormenu } = require('./RAFI/creatormenu')
//const { downloadmenu } = require('./RAFI/downloadmenu')
//const { allmenu } = require('./RAFI/allmenu')
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color('BURUAN SCAN!! Subscribe RAFI Graphy'))
	})

	fs.existsSync('./RAFI.json') && client.loadAuthInfo('./RAFI.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./RAFI.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const RAFIGraphy = ["6288221608614@s.whatsapp.net"]
     ...
     const bayarLimit = (sender, amount) => {
		...
		case 'daftar':
			...
			case 'RAFI':
                ...
                setTimeout( () => {
					costum(help(prefix, instagram, yt, name, pushname2, user, limitt), text, RAFIGraphy, replySet)
					}, 1500)
					setTimeout( () => {
					/*client.sendMessage(from, rules(name, uptime, tanggal, jam, prefix), text, {quoted: mek })
					}, 1200)
					setTimeout( () => {*/
					client.sendMessage(from, 'Terimakasih sudah menggunakan *RAFI Bot* \n\n*SEBAGAI PENGGANTI DONASI YUK SUPORT*\nSubscribe https://youtube.com/c/RAFIGraphy \nFollow instagram https://instagram.com/ahmd.fdhl_', text, {quoted: mek})
					}, 0)
    				break
/*********PISAH MENU**********/
              case 'ownermenu':
